...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('bg_forest_overview', 'assets/bg_forest_overview.png')
    this.load.image('bg_site_a',          'assets/bg_site_a.png')
    this.load.image('bg_site_b',          'assets/bg_site_b.png')
    this.load.image('bg_site_a_rain',     'assets/bg_site_a_rain.png')
    this.load.image('bg_site_b_rain',     'assets/bg_site_b_rain.png')
